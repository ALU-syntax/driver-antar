...
import com.insoftbumdesku.driver.models.JobModel;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    ImageView foto, gantifoto, backbtn, backButtonverify, fotosim, fotoktp, fotostnk, fotokendaraan;
    EditText phone, nama, email, numOne, numTwo, numThree, numFour, numFive, numSix, alamat, brand, type, vehiclenumber, color, idcardtext, driverlicensetext, referal;
    ...
    FirebaseAuth mAuth;
    byte[] imageByteArray, imageByteArrayktp, imageByteArraysim, imageByteArraystnk, imageByteArraykendaraan;
    Bitmap decoded, decodedktp, decodedsim, decodedstnk, decodedkendaraan;
    ...
    private void get() {
        ...
        jobs.setId(0);
        jobs.setJob("Pilih Pekerjaan");
        fiturlist.add(jobs);
        jobdata.add("Pilih Pekerjaan");
    ...
    public void Nextbtn(View view) {
        ...
        if ((!TextUtils.isEmpty(phoneNumber) && !TextUtils.isEmpty(ccode)) && phoneNumber.length() > 5) {
            ...
            notif("format nomor salah dan jangan gunakan 0 lagi!");
        }
    }
    ...
    private void upload(final String check) {
        ...
        request.setFotokendaraan(getStringImagekendaraan(decodedkendaraan));
        ...
        request.setReferal(referal.getText().toString());
