...
import com.insoftbumdesku.driver.models.FirebaseToken;
import com.insoftbumdesku.driver.models.User;
import com.insoftbumdesku.driver.utils.NetworkUtils;
        ...
        verificationCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    notif2("Kode otp salah!");
                } else if (e instanceof FirebaseTooManyRequestsException) {
                    notif2("Terlalu Banyak Permintaan, coba dengan nomor telepon lain!");
                    notif("Terlalu Banyak Permintaan, coba dengan nomor telepon lain!");
                }
            }
                ...
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("found")) {
                        if (verify.equals("false")) {
                            if(phoneText.getText().toString().equals(getString(R.string.loginplaystore))){
