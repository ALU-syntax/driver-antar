...
import com.insoftbumdesku.driver.models.Notif;
...
//        et_nominal.addTextChangedListener(Utility.currencyTW(et_nominal, this));
    ...
    private void settingMerchant(){
        ...
        duitku.setCallbackUrl("admin.bumdes-ku.com/api/Pelanggan/callbackUrl");
        duitku.setReturnUrl("admin.bumdes-ku.com/api/Pelanggan/returnUrl");
