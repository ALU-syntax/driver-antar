...
public class SendAudio {
    ...
    private final String tokenku;
    private final String Receiver_name;
    private final String Receiver_pic;
    ...
    private final EditText message_field;
    ...
    public void Runbeep(final String action){
        ...
        final MediaPlayer beep = MediaPlayer.create(context, R.raw.voice);
